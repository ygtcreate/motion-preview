...
export default function MotionStudio() {
  ...
  return <main><header><a className="brand" href="#"><span className="brand-mark">M</span><span>MOTION<br/><b>ARCHIVE</b></span></a><div className="header-meta"><span>LIBRARY</span><b>{motions.length.toString().padStart(2,"0")} MOTIONS</b></div><button className="source"><span className="pulse"/>CLOUDFLARE R2</button></header>
